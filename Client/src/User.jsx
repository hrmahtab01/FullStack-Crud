          ...
          userdata.map((item) => (
            ...
            >
              ...
              <div className="flex gap-3">
                <button className="py-2 px-3 bg-[#ffcc00] rounded-md text-lg font-semibold font-sans">
                  Update
                </button>
                <button className="py-2 px-3 bg-red-600 rounded-md text-lg font-semibold font-sans text-white">
                  Delete
                </button>
              </div>
            </div>
      ...
      {createdata && (
        <div className="w-full h-full bg-black/40 absolute top-0 left-0 px-3">
          <div className="w-[700px] h-[400px] rounded-md bg-green-400 mt-3">
            ...
            <button onClick={()=>Setcreatedata(false)} className="py-3 px-5 text-2xl font-semibold font-sans bg-red-500 border rounded-md ml-10 shadow-md text-white shadow-amber-600">back to previus</button>
          </div>
        </div>
      )}
    </div>
